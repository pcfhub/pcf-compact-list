...
(function () {
    ...
    function options() {
        ...
        return {
            ...
            inputs: {
                paging: document.getElementById('harness-paging').value,
                titleColumn: document.getElementById('harness-titlecolumn').value,
                detailColumns: Number(document.getElementById('harness-details').value) || 0,
                showLabels: document.getElementById('harness-showlabels').checked,
                density: document.getElementById('harness-density').value,
                openOnItemClick: document.getElementById('harness-openonclick').checked,
                showSearch: document.getElementById('harness-showsearch').checked,
